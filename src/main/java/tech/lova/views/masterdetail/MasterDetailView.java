package tech.lova.views.masterdetail;
...
public class MasterDetailView extends Div implements BeforeEnterObserver {
	...
	public MasterDetailView(final SamplePersonService samplePersonService) {
		...
		final LitRenderer<SamplePerson> importantRenderer = LitRenderer.<SamplePerson>of(
				...
				.withProperty("color", important -> important.isImportant() ? "var(--lumo-primary-text-color)"
